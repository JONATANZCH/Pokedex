...
const PokemonCard = ({pokemonUrl}) => {
    ...
    return (
        <article id='poster' className={`pokemonCard border-${pokemon?.types[0].type.name}`} onClick={handleClickPokemon}>
            ...
            <section className='pokemonCard__body'>
                <div className='pokemonCard__img'> 
                    <img src={pokemon?.sprites.other["official-artwork"].front_default} alt="imagePokemon" />
                </div>
